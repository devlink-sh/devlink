module github.com/devlink-sh/devlink
...
replace (
	github.com/openziti/sdk-golang => github.com/openziti/sdk-golang v0.20.99
	github.com/openziti/zrok => github.com/openziti/zrok v0.4.22
